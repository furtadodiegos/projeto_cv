...
class appTestDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if ('' === $trimmedPathinfo) {
            ...
            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::indexAction',  '_format' => 'json',  '_route' => 'app_default_index',);
        }
        ...
        if (0 === strpos($pathinfo, '/user')) {
            ...
            if ('/user' === $pathinfo) {
                ...
                return array (  '_controller' => 'AppBundle\\Controller\\UserController::indexAction',  '_format' => 'json',  '_route' => 'app_user_index',);
            }
            not_app_user_index:
            ...
            if ('/user/add' === $pathinfo) {
                if ('GET' !== $canonicalMethod) {
                    $allow[] = 'GET';
                    goto not_app_user_add;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\UserController::addAction',  '_format' => 'json',  '_route' => 'app_user_add',);
            }
            not_app_user_add:

            // app_user_insert
            if ('/user/insert' === $pathinfo) {
                if ('POST' !== $canonicalMethod) {
                    $allow[] = 'POST';
                    goto not_app_user_insert;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\UserController::insertAction',  '_format' => 'json',  '_route' => 'app_user_insert',);
            }
            not_app_user_insert:
        ...
        elseif (0 === strpos($pathinfo, '/Route')) {
            ...
            if (preg_match('#^/Route/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'app_user_delete')), array (  '_controller' => 'AppBundle\\Controller\\UserController::deleteAction',  '_format' => 'json',));
            }
            not_app_user_delete:
